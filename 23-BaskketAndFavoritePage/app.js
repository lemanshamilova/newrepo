...
function createCard(element, page) {
    ...
    shoppingIcon.className = "fa-solid fa-cart-shopping"
    shoppingIcon.style.fontSize = "30px"
    shoppingIcon.style.color = "black"
    shoppingIcon.style.textAlign = "right"
    shoppingIcon.style.position = "relative"
    shoppingIcon.style.bottom = "5px"
    shoppingIcon.style.left = "20px"
    ...
    //     let element=api.find((element)=>element.id == e.target.getAttribute("data"));
    //     createCard(element,BasketList)


    // })
    page.append(cards)
    cards.append(shoppingIcon);
    cards.append(favIcon);
    cards.append(img)
    cards.append(title)
    cards.append(price)
    cards.append(basketBtn)
    HomeList.append(cards)
    ...
    basketBtn.addEventListener("click", () => {
        ...
        if (newArr.find(element => element.id == basketBtn.getAttribute("data"))) {
            newArr = newArr.map((element) => {
                if (element.id == basketBtn.getAttribute("data")) {
        ...
        newArr.forEach(element => {
            ...
            btn2.addEventListener("click", () => {
                if (span2.innerText == 0) {
                    newArr = newArr.filter((element) => element.id != basketBtn.getAttribute("data"));
